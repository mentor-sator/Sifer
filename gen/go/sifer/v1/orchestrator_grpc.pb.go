...
const (
	OrchestratorService_Echo_FullMethodName = "/sifer.v1.OrchestratorService/Echo"
)
...
func (c *orchestratorServiceClient) Echo(ctx context.Context, in *EchoRequest, opts ...grpc.CallOption) (*EchoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EchoResponse)
	err := c.cc.Invoke(ctx, OrchestratorService_Echo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrchestratorServiceServer) Echo(context.Context, *EchoRequest) (*EchoResponse, error) {
...
func _OrchestratorService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EchoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrchestratorServiceServer).Echo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrchestratorService_Echo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrchestratorServiceServer).Echo(ctx, req.(*EchoRequest))
	}
...
var OrchestratorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sifer.v1.OrchestratorService",
	HandlerType: (*OrchestratorServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Echo",
			Handler:    _OrchestratorService_Echo_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "sifer/v1/orchestrator.proto",
}
